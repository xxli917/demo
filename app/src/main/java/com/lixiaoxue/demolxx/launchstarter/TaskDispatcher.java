package com.lixiaoxue.demolxx.launchstarter;

import android.content.Context;
import android.os.Looper;
import android.util.Log;
import com.lixiaoxue.demolxx.launchstarter.sort.TaskSortUtil;
import com.lixiaoxue.demolxx.launchstarter.stat.TaskStat;
import com.lixiaoxue.demolxx.launchstarter.task.DispatchRunnable;
import com.lixiaoxue.demolxx.launchstarter.task.Task;
import com.lixiaoxue.demolxx.launchstarter.task.TaskCallBack;
import com.lixiaoxue.demolxx.launchstarter.utils.DispatcherLog;
import com.lixiaoxue.demolxx.utils.AppUtil;
...
public class TaskDispatcher {
    ...
    private AtomicInteger mNeedWaitCount = new AtomicInteger();//保存需要Wait的Task的数量 高并发的情况下，i++无法保证原子性
    ...
    public static void init(Context context) {
        if (context != null) {
            sContext = context;
            sHasInit = true;
            sIsMainProcess = AppUtil.isMainProcess(sContext);
        }
    }
