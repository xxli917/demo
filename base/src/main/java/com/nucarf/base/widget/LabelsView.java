...
//            }
    ...
    private Drawable getStateListDrawable(int norCol, int selCol) {
        ...
        if (label_normal_bg == Color.parseColor("#333333")) {
            //设置背景色
            drawable_normal.setColor(Color.WHITE);
            drawable_normal.setStroke(1, getColorWithAlpha(0.3f,label_normal_bg));
        } else {
            //设置边框的厚度以及边框的颜色
            drawable_normal.setStroke(1, getColorWithAlpha(0.6f, norCol));
            drawable_normal.setColor(label_normal_bg);
            drawable_normal.setAlpha(30);
        }
